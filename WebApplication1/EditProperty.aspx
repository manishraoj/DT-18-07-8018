                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-2">
                                <label class="radio-inline">
                                    <asp:RadioButton GroupName="grpPropertyOption" ID="rdbSell" runat="server" Text="Sell"  />
                                    <%--<input type="radio" id="femaleRadio" value="Female">Female--%>
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <label class="radio-inline">
                                    <asp:RadioButton GroupName="grpPropertyOption" ID="rdbRent" runat="server" Text="Rent"  />
                                   <%-- <input type="radio" id="maleRadio" value="Male">Male--%>
                                </label>
                            </div>
